...
var extendStatics =
	 ...
	 * ({ __proto__: [] } instanceof Array && function (TurnOver, b) { TurnOver.__proto__ = b; }) ||
	 */
...
var DragListener = /** @class */ (function () {
    ...
    DragListener.prototype.scrollIntervalFunc = function () {
        var el = this.scrollEl;
        var frac = this.scrollIntervalMs / 1000; // considering animation frequency, what the vel should be mult'TurnOver by
